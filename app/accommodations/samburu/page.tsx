...
export default function SamburuAccommodationsPage() {
  const [selectedType, setSelectedType] = useState<(typeof accommodationTypes)[number]>("all")

  const samburuAccommodations = accommodations.filter((acc) => acc.destinationId === "samburu")
  const filteredAccommodations =
    selectedType === "all"
      ? samburuAccommodations
      : samburuAccommodations.filter((acc) => acc.type === selectedType)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="https://afribay.vercel.app/sambur.jpg"
            alt="Samburu Accommodations"
            fill
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="font-serif text-5xl md:text-6xl font-bold mb-6">Samburu Accommodations</h1>
          <p className="text-xl md:text-2xl font-light leading-relaxed">
            Discover unique wildlife and rich Samburu culture in Kenya's northern frontier
          </p>
        </div>
      </section>
            ...
            {filteredAccommodations.length === 0 && (
              <div className="col-span-full text-center py-12">
                <p className="text-gray-600 text-lg">
                  No accommodations currently available for Samburu. Please check back soon!
                </p>
      ...
      <section className="py-16 bg-afribay-dark-green text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl mb-8 opacity-90">
            Discover unique wildlife species and immerse yourself in authentic Samburu culture
          </p>
