...
export default function ZanzibarAccommodationsPage() {
  const [selectedType, setSelectedType] = useState<(typeof accommodationTypes)[number]>("all")

  const zanzibarAccommodations = accommodations.filter((acc) => acc.destinationId === "zanzibar")
  const filteredAccommodations =
    selectedType === "all"
      ? zanzibarAccommodations
      : zanzibarAccommodations.filter((acc) => acc.type === selectedType)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="https://afribay.vercel.app/zanzibar.jpg"
            alt="Zanzibar Accommodations"
            fill
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="font-serif text-5xl md:text-6xl font-bold mb-6">Zanzibar Accommodations</h1>
          <p className="text-xl md:text-2xl font-light leading-relaxed">
            Experience the magic of the Spice Island in luxury hotels and boutique properties
          </p>
        </div>
      </section>
            ...
            {filteredAccommodations.length === 0 && (
              <div className="col-span-full text-center py-12">
                <p className="text-gray-600 text-lg">
                  No accommodations currently available for Zanzibar. Please check back soon!
                </p>
                <p className="text-gray-500 text-sm mt-2">
                  Contact us for custom accommodation arrangements on the Spice Island.
                </p>
              </div>
            )}
          </div>
      ...
      <section className="py-16 bg-afribay-dark-green text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-6">Discover the Spice Island</h2>
          <p className="text-xl mb-8 opacity-90">
            Immerse yourself in Zanzibar's rich culture, pristine beaches, and aromatic spice tours
          </p>
