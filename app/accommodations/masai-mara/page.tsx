...
export default function MasaiMaraAccommodationsPage() {
  const [selectedType, setSelectedType] = useState<(typeof accommodationTypes)[number]>("all")

  const masaiMaraAccommodations = accommodations.filter((acc) => acc.destinationId === "masai-mara")
  const filteredAccommodations =
    selectedType === "all"
      ? masaiMaraAccommodations
      : masaiMaraAccommodations.filter((acc) => acc.type === selectedType)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="https://afribay.vercel.app/masai-mara.jpg"
            alt="Masai Mara Accommodations"
            fill
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="font-serif text-5xl md:text-6xl font-bold mb-6">Masai Mara Accommodations</h1>
          <p className="text-xl md:text-2xl font-light leading-relaxed">
            Stay in the heart of Africa's greatest wildlife spectacle
          </p>
        </div>
      </section>
            ...
            {filteredAccommodations.length === 0 && (
              <div className="col-span-full text-center py-12">
                <p className="text-gray-600 text-lg">
                  No accommodations currently available for Masai Mara. Please check back soon!
                </p>
                <p className="text-gray-500 text-sm mt-2">
                  Contact us for custom accommodation arrangements in this iconic destination.
                </p>
              </div>
            )}
          </div>
      ...
      <section className="py-16 bg-afribay-dark-green text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-6">Witness the Great Migration</h2>
          <p className="text-xl mb-8 opacity-90">
            Experience one of nature's most spectacular events from the comfort of luxury safari accommodations
          </p>
