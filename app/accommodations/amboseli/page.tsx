...
export default function AmboseliAccommodationsPage() {
  const [selectedType, setSelectedType] = useState<(typeof accommodationTypes)[number]>("all")

  const amboseliAccommodations = accommodations.filter((acc) => acc.destinationId === "amboseli")
  const filteredAccommodations =
    selectedType === "all"
      ? amboseliAccommodations
      : amboseliAccommodations.filter((acc) => acc.type === selectedType)

  return (
        <PageTransition type="elegant" duration={600}> {/* ADDED WRAPPER */}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="https://afribay.vercel.app/amboseli-1.jpg"
            alt="Amboseli Accommodations"
            fill
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="font-serif text-5xl md:text-6xl font-bold mb-6">Amboseli Accommodations</h1>
          <p className="text-xl md:text-2xl font-light leading-relaxed">
            Stay with stunning views of Mount Kilimanjaro and large elephant herds
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-afribay-dark-green text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-6">Majestic Kilimanjaro Awaits</h2>
          <p className="text-xl mb-8 opacity-90">
            Wake up to breathtaking views of Africa's highest peak and incredible wildlife encounters
          </p>
        ...
        </PageTransition> /* ADDED CLOSING WRAPPER */
