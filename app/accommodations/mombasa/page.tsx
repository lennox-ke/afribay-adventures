...
export default function MombasaAccommodationsPage() {
  const [selectedType, setSelectedType] = useState<(typeof accommodationTypes)[number]>("all")

  const mombasaAccommodations = accommodations.filter((acc) => acc.destinationId === "mombasa")
  const filteredAccommodations =
    selectedType === "all"
      ? mombasaAccommodations
      : mombasaAccommodations.filter((acc) => acc.type === selectedType)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="https://afribay.vercel.app/mombasa.jpg"
            alt="Mombasa Accommodations"
            fill
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="font-serif text-5xl md:text-6xl font-bold mb-6">Mombasa Accommodations</h1>
          <p className="text-xl md:text-2xl font-light leading-relaxed">
            Discover luxury beachfront resorts and historic hotels in Kenya's coastal jewel
          </p>
        </div>
      </section>
            ...
            {filteredAccommodations.length === 0 && (
              <div className="col-span-full text-center py-12">
                <p className="text-gray-600 text-lg">
                  No accommodations currently available for Mombasa. Please check back soon!
                </p>
                <p className="text-gray-500 text-sm mt-2">
                  Contact us for custom accommodation arrangements in this historic destination.
                </p>
              </div>
            )}
          </div>
      ...
      <section className="py-16 bg-afribay-dark-green text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-6">Experience Mombasa's Rich Heritage</h2>
          <p className="text-xl mb-8 opacity-90">
            Combine luxury accommodation with cultural exploration in Kenya's historic coastal city
          </p>
